<?php
// Expects $activeNav ('home' | 'habits' | 'finance' | 'learning') and $initial to be set by the including page.
$navItems = [
...
<div class="sidebar">
    ...
    <?php endforeach; ?>
    <a href="#" class="nav-icon bottom-icon" title="Settings (coming soon)">
